...
MODIFIED_FIRE::MODIFIED_FIRE(std::shared_ptr<fresco::BasePotential> potential,
        std::vector<double>& x0, double dtstart, double dtmax, double maxstep,
...
void MODIFIED_FIRE::set_func_gradient(double f, std::vector<double> grad)
{
