#ifndef _FRESCO_CELL_LISTS_HPP
#define _FRESCO_CELL_LISTS_HPP
...
public:
    ...
    fresco::VecN<ndim> m_boxvec;
    fresco::VecN<ndim> m_inv_boxvec; //!< inverse of boxvec
    double m_rcut;
    cell_vec_t m_ncells_vec; //!< the number of cells in each dimension
    fresco::VecN<ndim> m_rcell_vec; //!< the cell length in each dimension
    size_t m_ncells;
    size_t m_nsubdoms;
    ...
    double minimum_distance(cell_vec_t const & v1, cell_vec_t const & v2) const
    {
        ...
        fresco::VecN<ndim> ll1, ll2, dr;
        fresco::VecN<ndim> minimum_dist; // the minimum possible distance in each direction
...
public:
    CellListsLoop(
        ...
        fresco::LatticeNeighbors<distance_policy> lattice_tool)
        : m_visitor(visitor),
...
protected:
    ...
    fresco::LatticeNeighbors<distance_policy> m_lattice_tool;
...
#endif // #ifndef _FRESCO_CELL_LISTS_HPP
