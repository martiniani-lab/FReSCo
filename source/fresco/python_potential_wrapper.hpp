#ifndef _FRESCO_POTENTIAL_FUNCTION_H
#define _FRESCO_POTENTIAL_FUNCTION_H
...
{
    public:
        typedef double EnergyCallback(std::vector<double>, void *);
        typedef double EnergyGradientCallback(std::vector<double>, std::vector<double>, void *);
        ...
        virtual double get_energy(std::vector<double> const & x) { return (*_get_energy)(x, _userdata); } ;
        virtual double get_energy_gradient(std::vector<double> const & x, std::vector<double> & grad) {  return (*_get_energy_gradient)(x, grad, _userdata); }
    private:
...
public:
     ...
     */
    virtual double get_energy(std::vector<double> const & x)
    {
     ...
     */
    virtual double get_energy_gradient(std::vector<double> const & x, std::vector<double> & grad)
    {
        if (x.size() != grad.size()) {
